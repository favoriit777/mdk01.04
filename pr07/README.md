...
Базовый класс: BankAccount (банковский счет) Производные классы: SavingsAccount , CheckingAccount, CreditAccount, DepositAccount Методы: Deposit() , Withdraw(), CalculateInterest(),GetAccountInfo()
